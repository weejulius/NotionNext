...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ruyuan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一切如愿', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ruyuan.ink', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '如愿应用', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '浙ICP备2023005089号-1', // 备案号 闽ICP备XXXXXXX
